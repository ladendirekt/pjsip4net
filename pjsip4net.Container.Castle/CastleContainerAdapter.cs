...
namespace pjsip4net.Container.Castle
{
    ...
    /// </summary>
    public class CastleContainerAdapter : IContainer
    {
        private readonly IWindsorContainer _windsorContainer;

        /// <summary>
        /// Create a new instance of <see cref="CastleContainerAdapter"/> with its' own instance of <see cref="IWindsorContainer"/>
        /// </summary>
        public CastleContainerAdapter()
        {
            _windsorContainer = new WindsorContainer();
        }

        /// <summary>
        /// Create a new instance of <see cref="CastleContainerAdapter"/> with existing <see cref="IWindsorContainer"/>.
        /// </summary>
        /// <param name="windsorContainer"></param>
        public CastleContainerAdapter(IWindsorContainer windsorContainer)
        {
            _windsorContainer = windsorContainer;
        }
        
        private T Wrap<T>(Func<T> resolveOrRegister)
        {
            try
            {
                return resolveOrRegister();
            }
